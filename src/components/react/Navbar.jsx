...
import menuData from "../../data/nav_anchors.json";
      ...
      <div className="icon-group flex gap-4 sm:gap-7">
        <div className="">
          <label className="swap swap-rotate">
            ...
            <svg
              className={`dark:fill-textdark ${themeNow === "light" ? "swap-on" : "swap-off"} h-[26px] w-[26px] fill-gray-600`}
            ...
            <svg
              className={`dark:fill-textdark ${themeNow === "dark" ? "swap-on" : "swap-off"} h-[26px] w-[26px] fill-gray-600`}
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
            >
