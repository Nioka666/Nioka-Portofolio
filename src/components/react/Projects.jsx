        ...
        <section className="projects-content">
          ...
          <div className="card bg-nioprimary dark:bg-niodark max-sm:w-full sm:w-[410px] text-center h-36 md:h-72 mb-14">
            <div className="my-auto md:mt-20">
              ...
              <h1 className="text-2xl md:text-3xl mt-5 text-niodark md:text-gray-300 dark:text-textdark5 font-extralight md:font-semibold">What's next?</h1>
              <p className="text-base max-sm:font-semibold max-sm:text-sm text-textdark5 md:text-gray-300 dark:text-textdark5 max-sm:mt-1">perhaps the next idea is yours!</p>
            </div>
          </div>
