function ProjectDetails({ url, slug, title, banner_img, date, p1, p2, p3, github_url }) {
    return (
        <>
            <section className="navigation mt-[-20px] flex justify-between px-16 max-sm:px-[24px] max-sm:mt-[-40px]">
            ...
            <section className="project-details-component mt-6 px-6 md:px-16">
