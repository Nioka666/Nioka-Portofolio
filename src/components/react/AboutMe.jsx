          ...
          <div className="about-desc-wrapper">
            <div className="about-boxes">
              ...
              {boxData.map((box) => (
                <div
                  key={box.id}
                  className="grid w-[150px] cursor-pointer gap-1 rounded-[20px] px-6 py-5 text-center text-black dark:text-textdark max-sm:w-[130px] max-sm:px-[10px] max-sm:py-4 md:border-0 max-sm:border-b-2 max-sm:bg-white"
                >
                  <i
