/* empty css                                 */
import { c as createComponent, r as renderTemplate, m as maybeRenderHead, a as addAttribute, d as renderHead, e as renderComponent, f as renderSlot, b as createAstro } from '../chunks/astro/server_CYvFiNM-.mjs';
import 'kleur/colors';
    ...
    /* @__PURE__ */ jsxs("div", { className: "icon-group flex gap-4 sm:gap-7", children: [
      ...
      /* @__PURE__ */ jsxs(
        "div",
        {
          ...
          "data-tip": "Menu",
          children: [
            /* @__PURE__ */ jsx("button", { role: "button", className: "", children: /* @__PURE__ */ jsx("i", { className: "bx bx-menu-alt-right cursor-pointer text-[26px] font-medium text-gray-600 transition-all hover:text-gray-400" }) }),
            /* @__PURE__ */ jsx(
              "div",
              {
...
function BottomNav() {
  ...
  return /* @__PURE__ */ jsxs("div", { ...SwipeHandler, className: "bottom-nav", children: [
    /* @__PURE__ */ jsxs("section", { className: "b-nav-shadow bg-nioprimary flex h-[60px] w-full items-center justify-between px-7", children: [
...
const $$Footer = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<footer> <div class="max-sm:py-10 h-52 max-sm:px-10 lg:py-20 lg:px-20 rounded-2xl mt-36 bg-nioprimary"> <section class="text-center"> <h1 class="text-base sm:text-sm md:text-xl font-medium"> ${"<"}Adhim Niokagi ${"/> "} </h1> <h2 class="text-gray-400 text-[12px] sm:text-sm">Portofolio website</h2> </section> </div> </footer>`;
...
const CV = "/_astro/Muhammad_Adhim_Niokagi_CV.BwiuzTrq.pdf";
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsxs("section", { className: "hero", children: [
      ...
      /* @__PURE__ */ jsxs("section", { className: "headline", children: [
        ...
        /* @__PURE__ */ jsxs("h6", { className: "text-black md:mt-3 md:text-base lg:mt-1 lg:text-xl", children: [
          /* @__PURE__ */ jsx("i", { className: "uil uil-minus" }),
          " ",
          /* @__PURE__ */ jsx("i", { className: "uil uil-minus ms-[-15px]" }),
          " ",
          /* @__PURE__ */ jsx("i", { className: "uil uil-minus ms-[-15px]" }),
          " ",
          /* @__PURE__ */ jsx("i", { className: "uil uil-minus ms-[-15px]" }),
          " ",
          /* @__PURE__ */ jsx("span", { className: "ms-2", children: "Front-End Developer" })
        ] }),
        /* @__PURE__ */ jsx("div", { className: "text-gray mt-5 h-[80px] w-[85%] font-normal md:text-[14px] lg:text-[16.5px]", children: /* @__PURE__ */ jsx(
          Typewriter,
          {
            onInit: (typewriter) => {
              typewriter.typeString("I'm a").pauseFor(500).typeString(" Front-End Developer,").pauseFor(1e3).typeString(" work based in Mojokerto, East Java,").pauseFor(1e3).typeString(" passionate and dedicated to my work.").start();
            },
            options: {
              autoStart: true
            }
        ...
        /* @__PURE__ */ jsxs("div", { className: "mt-10 flex gap-5", children: [
          /* @__PURE__ */ jsxs("button", { role: "button", className: "rounded-[18px] bg-gray-800 py-[17px] font-medium text-white transition-all hover:bg-white hover:text-black hover:shadow-md md:px-[25px] md:text-sm lg:px-9 lg:text-base", children: [
            "Say Hello",
            " ",
            /* @__PURE__ */ jsx("i", { className: "uil uil-location-arrow md:ms-1 lg:ms-2" })
          ] }),
          /* @__PURE__ */ jsx("a", { href: CV, target: "_blank", children: /* @__PURE__ */ jsxs("button", { role: "button", className: "flex items-center rounded-2xl bg-transparent py-[15px] font-medium text-black max-sm:text-sm md:px-4 md:text-sm lg:px-7 lg:text-base", children: [
            "View CV",
      ...
      /* @__PURE__ */ jsx(
        "picture",
        {
          className: `blob overflow-hidden me-[10px] ${loaded ? "animate-fade-in" : "opacity-0"} md:mt-[-30px] md:w-[260px] lg:h-[315px] lg:w-[325px]`,
    ...
    /* @__PURE__ */ jsxs("section", { className: "sm-hero", children: [
      /* @__PURE__ */ jsxs("div", { className: "mt-16 flex items-center px-6 max-sm:gap-9 max-miniphone:gap-5 sm:gap-10", children: [
        ...
        /* @__PURE__ */ jsx(
          "picture",
          {
            className: `blob overflow-hidden max-md:ms-[2px] max-miniphone:ms-[-3px] ${loaded ? "animate-fade-in" : "opacity-0"} max-md:w-[290px] max-sm:h-full max-sm:w-[227px] max-miniphone:w-[223px] sm:h-full sm:w-[270px] md:h-full md:w-[250px] lg:h-full`,
            children: /* @__PURE__ */ jsx("img", { src: avatar$1.src, alt: "Adhim Niokagi" })
          }
        )
      ] }),
      /* @__PURE__ */ jsxs("section", { className: "mx-6 mt-7 flex flex-col", children: [
        /* @__PURE__ */ jsx("h1", { className: "font-semibold max-sm:text-[40px] max-miniphone:text-[28px] sm:text-[38.5px]", children: "Adhim Niokagi" }),
        /* @__PURE__ */ jsxs("h6", { className: "text-lg text-black max-sm:text-[19px] max-miniphone:text-[14px] sm:text-xl", children: [
          /* @__PURE__ */ jsx("i", { className: "uil uil-minus" }),
          " ",
          /* @__PURE__ */ jsx("i", { className: "uil uil-minus ms-[-15px]" }),
          " ",
        ...
        /* @__PURE__ */ jsx("div", { className: "text-niogray mt-[13.5px] h-[95px] max-miniphone:h-[70px] w-full leading-7 max-miniphone:leading-5 max-sm:text-[16.7epx] max-miniphone:text-[13px] sm:text-[17px]", children: /* @__PURE__ */ jsx(
          Typewriter,
          {
            onInit: (typewriter) => {
              typewriter.typeString("I'm a").pauseFor(500).typeString(" Front-End Developer,").pauseFor(1e3).typeString(" work based in Mojokerto, East Java,").pauseFor(1e3).typeString(" and dedicated to my work.").start();
            },
            options: {
              autoStart: true
            }
        ...
        /* @__PURE__ */ jsxs("div", { className: "mt-10 flex items-center gap-5 max-sm:mt-8 max-miniphone:gap-2", children: [
          /* @__PURE__ */ jsxs("button", { role: "button", className: "rounded-[17px] bg-gray-800 px-8 py-[18px] max-miniphone:py-[15.7px] text-sm font-medium text-white transition-all hover:bg-nioprimary hover:text-black max-miniphone:px-6 max-miniphone:text-[11px]", children: [
            "Say Hello ",
            /* @__PURE__ */ jsx("i", { className: "uil uil-location-arrow ms-1" })
          ] }),
          /* @__PURE__ */ jsx("a", { href: CV, target: "_blank", children: /* @__PURE__ */ jsxs("button", { role: "button", className: "flex items-center max-miniphone:hidden gap-2 rounded-2xl bg-transparent px-6 text-sm max-miniphone:text-[10px] font-medium text-black", children: [
            "View CV",
...
const avatar = new Proxy({"src":"/_astro/adhim_3hp.CCvUUHCC.jpeg","width":2822,"height":2822,"format":"jpg"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxs("section", { className: "text-center", children: [
          /* @__PURE__ */ jsx("h1", { className: "text-2xl font-semibold text-black sm:text-2xl md:text-4xl", children: "About Me" }),
          /* @__PURE__ */ jsx("h3", { className: "mt-2 text-sm text-gray-400 max-sm:mt-0 md:text-[17px]", children: "Introduction" })
        ] }),
        /* @__PURE__ */ jsxs("section", { className: "mt-16 justify-between gap-16 max-sm:mt-8 lg:flex", children: [
          /* @__PURE__ */ jsx("div", { className: "flex md:w-1/2 justify-center mx-auto", children: /* @__PURE__ */ jsx("picture", { className: "", children: /* @__PURE__ */ jsx(
            "img",
            {
              src: avatar.src,
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex-col max-sm:mt-7 max-sm:px-5 sm:px-10 md:px-0 lg:w-1/2", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex gap-4 max-lg:my-7 max-lg:justify-center max-sm:justify-center max-sm:gap-0", children: [
              /* @__PURE__ */ jsxs("div", { className: "grid w-[150px] gap-1 rounded-[20px] bg-nioprimary px-6 py-5 text-center text-black max-sm:w-[130px] max-sm:bg-gray-100 max-sm:px-[17px] max-sm:py-4 md:border-0", children: [
                /* @__PURE__ */ jsx("i", { className: "bx bx-time-five mb-2 text-[26px] max-sm:mb-1 max-sm:text-[20px]" }),
                /* @__PURE__ */ jsx("p", { className: "mt-0 text-[14px] text-black max-sm:text-[11px]", children: "Experience" }),
                /* @__PURE__ */ jsx("p", { className: "text-[8.9px] text-gray-500", children: "1 + Year Working" })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "grid w-[150px] gap-1 rounded-[20px] bg-nioprimary px-6 py-5 text-center text-black max-sm:w-[130px] max-sm:px-[17px] max-sm:py-4 md:border-0", children: [
                /* @__PURE__ */ jsx("i", { className: "bx bx-code-block mb-2 text-[26px] max-sm:mb-1 max-sm:text-[20px]" }),
                /* @__PURE__ */ jsx("p", { className: "mt-0 text-[14px] text-black max-sm:text-[11px]", children: "Completed" }),
                /* @__PURE__ */ jsx("p", { className: "text-[8.9px] text-gray-500", children: "5 Projects" })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "grid w-[150px] gap-1 rounded-[20px] bg-nioprimary px-6 py-5 text-center text-black max-sm:w-[130px] max-sm:px-[17px] max-sm:py-4 md:border-0", children: [
                /* @__PURE__ */ jsx("i", { className: "bx bx-medal mb-2 text-[26px] max-sm:mb-1 max-sm:text-[20px]" }),
                /* @__PURE__ */ jsx("p", { className: "mt-0 text-[14px] text-black max-sm:text-[11px]", children: "Licenses" }),
                /* @__PURE__ */ jsx("p", { className: "text-[8.9px] text-gray-500", children: "15+ Certifications" })
              ] })
            ] }),
            /* @__PURE__ */ jsx("div", { className: "mockup-window bg-gray-200 mt-5 shadow-sm", children: /* @__PURE__ */ jsx("div", { className: "bg-nioprimary px-6 max-sm:px-0 max-sm:py-7 py-7", children: /* @__PURE__ */ jsx("p", { className: "text-center text-gray-500 max-sm:mt-[-5px] max-sm:px-6 max-sm:text-[11.5px] sm:text-center sm:text-base md:text-left md:text-[16px]", children: "As a Front-End Web Developer, I am highly dedicated to supporting your company or project. I have extensive experience with several up-to-date technology frameworks such as ReactJs, Express.js, and Next.js. I am proficient in managing databases and implementing complex business logicals." }) }) })
          ] })
        ] })
      ]
    }
...
const cssIcon = new Proxy({"src":"/_astro/css.bLrZJUBe.png","width":512,"height":512,"format":"png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
...
const jsIcon = new Proxy({"src":"/_astro/js.Bu6ZFjaT.png","width":512,"height":512,"format":"png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
...
const tailwindIcon = new Proxy({"src":"/_astro/Tailw.Biu2-V6X.png","width":512,"height":512,"format":"png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
...
const bootstrapIcon = new Proxy({"src":"/_astro/bootstrap.D4feuazP.png","width":512,"height":512,"format":"png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
...
const reactIcon = new Proxy({"src":"/_astro/reactjs.DbavuWM8.png","width":512,"height":512,"format":"png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
...
const viteIcon = new Proxy({"src":"/_astro/vite.B8HcBvK4.png","width":512,"height":512,"format":"png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
...
const figmaIcon = new Proxy({"src":"/_astro/Figma.-bIlWn4j.png","width":512,"height":512,"format":"png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
...
const nodeJsIcon = new Proxy({"src":"/_astro/nodejs.BdPFpv2v.png","width":512,"height":512,"format":"png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
...
const expressIcon = new Proxy({"src":"/_astro/Express.BhDIol1Y.png","width":512,"height":512,"format":"png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
...
const phpIcon = new Proxy({"src":"/_astro/php.UFe6EMyZ.png","width":512,"height":512,"format":"png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
...
const laravelIcon = new Proxy({"src":"/_astro/Laravel.CdgKIkwT.png","width":512,"height":512,"format":"png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
...
const mysqlIcon = new Proxy({"src":"/_astro/MySQL.D2b_KIHY.png","width":512,"height":512,"format":"png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
...
const mongodbIcon = new Proxy({"src":"/_astro/mongodb.CzrTCLas.png","width":512,"height":512,"format":"png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
...
const postmanIcon = new Proxy({"src":"/_astro/Postman.CqkmMONA.png","width":512,"height":512,"format":"png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
...
new Proxy({"src":"/_astro/Nest.js.hGaMNWMk.png","width":512,"height":512,"format":"png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
...
function Skills() {
  ...
  const SkillCollapse = ({ title, dataVariable }) => {
    return /* @__PURE__ */ jsxs("details", { className: "collapse bg-gray-200 transition-all ease-in-out", children: [
      /* @__PURE__ */ jsx("summary", { className: "collapse-title py-5 text-[21px] font-semibold text-gray-500 max-sm:text-[17px]", children: /* @__PURE__ */ jsxs("div", { className: "my-2 max-sm:my-0 flex items-center gap-2 max-sm:justify-center max-md:justify-center lg:ms-14", children: [
        /* @__PURE__ */ jsx("i", { className: "bx bx-code-curly text-2xl" }),
        /* @__PURE__ */ jsx("span", { children: title })
      ] }) }),
      /* @__PURE__ */ jsx("div", { className: "collapse-content mx-10 my-7 grid grid-cols-5 max-sm:grid-cols-4 justify-items-center gap-10 max-sm:mx-0 max-sm:my-3 max-sm:gap-4", children: dataVariable.map((iconData) => /* @__PURE__ */ jsx(
        "img",
        {
          src: iconData.src,
          alt: iconData.id,
  ...
  return /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsxs("div", { id: "skills", className: "skills mt-14 py-10 lg:px-10", children: [
    /* @__PURE__ */ jsxs("section", { className: "text-center", children: [
      /* @__PURE__ */ jsx("h1", { className: "text-2xl font-semibold text-black sm:text-2xl md:text-4xl", children: "Technical Skills" }),
      /* @__PURE__ */ jsx("h3", { className: "mt-2 text-sm text-gray-400 max-sm:mt-0 md:text-[17px]", children: "My Competence" })
    ] }),
    /* @__PURE__ */ jsxs("section", { className: "mx-auto grid w-[90%] gap-7 py-10 max-md:w-[90%]", children: [
      /* @__PURE__ */ jsx(SkillCollapse, { title: "Front-End Development", dataVariable: frontEndData }),
      /* @__PURE__ */ jsx(SkillCollapse, { title: "Back-End Development", dataVariable: backEndData })
    ] })
  ] }) });
}
  ...
  return /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsx("section", { className: "max-md:mt-10 max-md:px-8 max-sm:mt-8 lg:mt-10", children: /* @__PURE__ */ jsxs("ul", { className: "timeline timeline-vertical timeline-snap-icon max-md:timeline-compact", children: [
    /* @__PURE__ */ jsxs("li", { children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "timeline-end md:timeline-start max-md:ms-3 md:mb-10 md:me-5 md:text-end", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "text-lg font-bold max-sm:text-base", children: "Politeknik Elektronika Negeri Surabaya" }),
        "Associate's degree ",
        /* @__PURE__ */ jsx("br", {}),
    ...
    /* @__PURE__ */ jsxs("li", { children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "timeline-end max-md:ms-3 md:ms-5 lg:mb-10", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "text-lg font-bold max-sm:text-base", children: "SMK Negeri 2 Mojokerto" }),
    ...
    /* @__PURE__ */ jsxs("li", { children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "timeline-end mb-10 md:timeline-start max-md:ms-3 md:me-5 md:text-end", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "text-lg font-bold max-sm:text-base", children: "SMP Negeri 1 Jetis" }),
        "General Student"
      ] })
    ] })
  ] }) }) });
  ...
  return /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsx("section", { className: "max-md:mt-10 max-md:px-8 max-sm:mt-8 lg:mt-10", children: /* @__PURE__ */ jsxs("ul", { className: "timeline timeline-vertical timeline-snap-icon max-md:timeline-compact", children: [
    /* @__PURE__ */ jsxs("li", { children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "timeline-end md:timeline-start max-md:ms-3 md:mb-10 md:me-5 md:text-end", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "text-lg font-bold", children: "Independent Freelancer" }),
    ...
    /* @__PURE__ */ jsxs("li", { children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "timeline-end max-md:ms-3 md:ms-5 lg:mb-10", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "text-lg font-bold", children: "ATR/BPN - Kantor Pertanahan Kota Mojokerto" }),
        "Student Internship ",
        /* @__PURE__ */ jsx("br", {}),
        /* @__PURE__ */ jsx("br", {})
      ] })
...
function Qualification() {
  ...
  return /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsxs("div", { id: "qualification", className: "mt-16 py-10 max-sm:mt-16 h-[700px]", children: [
    /* @__PURE__ */ jsxs("section", { className: "text-center", children: [
      /* @__PURE__ */ jsx("h1", { className: "text-2xl font-semibold text-black sm:text-3xl md:text-4xl", children: "Qualifications" }),
      /* @__PURE__ */ jsx("h3", { className: "mt-2 text-sm text-gray-500 md:text-[17px]", children: "My Journey" })
    ] }),
    /* @__PURE__ */ jsxs("section", { className: "mt-16 flex justify-center gap-10 max-sm:mt-14", children: [
      /* @__PURE__ */ jsxs(
        "button",
        {
          ...
          children: [
            /* @__PURE__ */ jsx("i", { className: "bx bxs-graduation text-[30px]" }),
            " Educations"
          ]
        }
      ),
      /* @__PURE__ */ jsxs(
        "button",
        {
          ...
          children: [
            /* @__PURE__ */ jsx("i", { className: "bx bxs-briefcase text-[24px]" }),
            "Experiences"
          ]
        }
      )
    ] }),
    /* @__PURE__ */ jsx("section", { className: "max-sm:mx-4 sm:mx-2", children: activeMenu === 1 ? /* @__PURE__ */ jsx(Educations, {}) : /* @__PURE__ */ jsx(Experiences, {}) })
  ] }) });
}
